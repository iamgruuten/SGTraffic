...
//        Log.v(RippleDrawable.class.getSimpleName(), "touch: " + event.getAction() + " " + mState);
	...
	public static class Builder{
		...
		public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
			...
			rippleType(a.getInteger(R.styleable.RippleDrawable_rd_rippleType, com.rey.material.drawable.RippleDrawable.TYPE_TOUCH));
            delayClickType(a.getInteger(R.styleable.RippleDrawable_rd_delayClick, com.rey.material.drawable.RippleDrawable.DELAY_CLICK_NONE));
		...
		public com.rey.material.drawable.RippleDrawable build(){
